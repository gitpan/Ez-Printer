# This Makefile is for the Ez::Printer extension to perl.
#
...
#     ABSTRACT => q[An easy to use module that provides new ways of printing, like 'puts'.]
#     AUTHOR => [q[Alexej G. Magura <agm2819@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[BSD]
#     NAME => q[Ez::Printer]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Printer.pm]
...
INST_LIBDIR      = $(INST_LIB)/Ez
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Ez
...
TO_INST_PM = lib/Printer.pm

PM_TO_BLIB = lib/Printer.pm \
	blib/lib/Printer.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: "An easy to use module that provides new ways of printing, like '\''puts'\''."' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Alexej G. Magura <agm2819@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Ez-Printer' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "An easy to use module that provides new ways of printing, like '\''puts'\''.",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Alexej G. Magura <agm2819@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Ez-Printer",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>An easy to use module that provides new ways of printing, like '\''puts'\''.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Alexej G. Magura &lt;agm2819@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Printer.pm blib/lib/Printer.pm 
